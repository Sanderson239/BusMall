...
//   randomProducts[0] = productArray[Math.floor(Math.random() * productArray.length)];
//   randomProducts[1] = productArray[Math.floor(Math.random() * productArray.length)];
//   randomProducts[2] = productArray[Math.floor(Math.random() * productArray.length)];
// }

function setImageAttributes() {
  for (var i = 0; i < document.getElementsByClassName('products').length; i++) {
    var randomProduct = productArray[Math.floor(Math.random() * productArray.length)];
    if (randomProduct.counter > 0) {
      counter += i;
      i -= 1;
      randomProduct.counter = 0;
    }
    else {
